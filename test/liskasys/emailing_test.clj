...
-------------------------------------------------
CELKEM: 10\n\n"}]}
         (sut/lunch-order-msg "me@test-school.org"
...
(deftest name-att-diet-str-test
  (is (= "Miarka Oliver, bez oběda"
         (sut/name-att-diet-str {:daily-plan/person {:person/firstname "Oliver" :person/lastname "Miarka"}} )))
  (is (= "Miarka Oliver"
         (sut/name-att-diet-str {:daily-plan/person {:person/firstname "Oliver" :person/lastname "Miarka"}
                             :daily-plan/lunch-req 1})))
  (is (= "Miarka Oliver, strava vege"
         (sut/name-att-diet-str {:daily-plan/person {:person/firstname "Oliver" :person/lastname "Miarka" :person/lunch-type {:lunch-type/label "vege"}}
                             :daily-plan/lunch-req 1})))
...
(deftest name-excuse-str-test
  (is (= "Miarka Oliver"
         (sut/name-excuse-str {:daily-plan/person {:person/firstname "Oliver" :person/lastname "Miarka"}})))
...
(deftest today-child-counts-msg-test
  (is (= {:from "me@test-school.org",
         ...
         (sut/today-child-counts-msg "me@test-school.org"
                                 ["someone@yahoo.com" "anotherone@gmail.com"]
                                 config
...
Toto je automaticky generovaný email ze systému http://testschool.org/liskasys"}]}
         (sut/bill-published-msg "me@test-school.org"
                             config
...
(deftest substitution-result-msg-test
  (is (= {:from "me@test-school.org",
         ...
         (sut/substitution-result-msg "me@test-school.org"
                                  config
