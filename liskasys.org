...
** lunch-menu
** person-bill
*** join patterns and variable symbol from history
* TODOs
** new schema
...
**** prazdniny (27.12. - 31.12. + 1.7. - 31.8.) a "reditelske volno" (jednorazove)
**** vypocitat potrebnou castku do fondu obedu
...
*** active person filter, child/adult filter
...
*** vyrovnani obedu
** TODO form validation!!! clojure.spec
