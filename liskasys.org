...
**** TODO vypocitat potrebnou castku do fondu obedu
*** DONE generate daily plans for confirmed bills
CLOSED: [2016-09-17 Sat 22:08]
*** TODO migrate cancellations to daily plans (bill and plan creation for 9+10/16 be part of migration)
...
*** 5 day patterns 01111 (without Sa+Su)
*** deprecate old DB tables and GUIs
*** bugfix: deactivate parents with inactive kids
** TODO nahrady
