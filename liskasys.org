...
*** price list CRUD
*** vacations CRUD
*** generate person bills for period
*** generate daily plans for confirmed bills
*** migrate cancellations to daily plans
*** rewrite all code to use the new schema
**** cancellations
**** lunch orders
**** lunch and cancellations views
*** GUI for patterns editing
...
** TODO svatky, prazdniny (28. zari!!!!) a "reditelske volno" (jednorazove)
** TODO moznost nastavit odber obedu i bez dochazky (nektere deti, ale i dospeli)
** TODO Frantisek a Anicka maji obedy (budou platit) i dochazku (nebudou platit)
** TODO lektori maji obedy zdarma
** TODO nahrady
...
** TODO CRUD cenik
** TODO výpočet platby na příští období (ceník - odhlášené obědy + obedy na nove obdobi)
** TODO DB indexy
