...
* TODOs
** TODO remove jdbc dependencies (hikari, h2, clojure.jdbc ...)
** v platbe na pristi obdobi zohlednit stav fondu + budouci zrusene obedy
...
** zverejneni rozpisu plateb a jednotlive potvrzovani zaplaceni
** zobrazit rodicum platby a zrusene obedy
** sobotni akce - potvrzeni/odmitnuti ucasti
** moznost zobrazit historii zmen entity
** [#C] zrusit children-count
